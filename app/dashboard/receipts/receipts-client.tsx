...
import { Receipt, deleteReceipt as deleteReceiptAction } from "@/lib/receipts-server-actions";
...
export default function ReceiptsClient({ initialReceipts }: ReceiptsClientProps) {
  ...
  const handleAddReceipt = async (receiptData: Omit<Receipt, 'id' | 'createdAt'>) => {
    try {
