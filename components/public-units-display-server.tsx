...
interface PublicUnitsDisplayServerProps {
  city?: string; // Optional filter by city
}

export async function PublicUnitsDisplayServer({ city }: PublicUnitsDisplayServerProps) {
        ...
        >
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center mt-3">
              <span className="text-xs text-muted-foreground">الطابق: {unit.floor}</span>
