...
import { usePMSStore, type Invoice } from "@/lib/store"
...
export default function InvoicesPage() {
  const { invoices, deleteInvoice } = usePMSStore()
  ...
  const filteredInvoices = useMemo(() => {
    return invoices.filter((invoice) => {
      const matchesSearch =
        ...
        invoice.guest.includes(searchQuery)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <AddInvoiceModal open={addModalOpen} onOpenChange={setAddModalOpen} />
